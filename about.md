...
비즈니스 요구사항과 품질 속성 사이에서 가장 좋은 선택을 하여 팀을 성공으로 만들고 싶은 개발자 Las입니다.
...
리워드를 이용한 사용자의 리텐션과 참여도를 증가시키는 새로운 사업에 벡엔드를 담당하였습니다.
...
- 시니어 개발자로서 기술 문화와 테스팅, 업무 프로세스, 팀의 기술적인 방향을 제안
